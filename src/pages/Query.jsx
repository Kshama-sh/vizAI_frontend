...
//   const [previousQueriesLength, setPreviousQueriesLength] = useState(0);
...
//           );
//         }
//         // Store initial queries length
//         setPreviousQueriesLength(queries.queries_list.length);
//       } catch (err) {
//         console.error(" Error loading queries:", err);
//         setError(
//           "Failed to load queries. Please try reconnecting your database."
...
//   // Store the previous queries length whenever it changes
//   useEffect(() => {
//     setPreviousQueriesLength(queries.queries_list.length);
//   }, [queries.queries_list.length]);
...
//       console.log("Loading more queries with DB entry ID:", savedDbEntryId);
//       setLoading(true);

//       // Store the current length before loading more
//       const currentLength = queries.queries_list.length;

//       // Try to load more queries
//       await loadMoreQueries(savedDbEntryId);

//       // After loading, check if the length changed
//       // If the length didn't change, then no new queries were loaded
//       if (currentLength === queries.queries_list.length) {
//         setErrorDialogMessage("No more queries available to load.");
//         setIsErrorDialogOpen(true);
//       }
//     } catch (error) {
//       console.error("Error loading more queries:", error);
//       setErrorDialogMessage("Failed to load more queries.");
//       setIsErrorDialogOpen(true);
//     } finally {
//       setLoading(false);
//     }
...
//     } catch (error) {
//       console.error("Error adding queries to dashboard:", error);
//       setErrorDialogMessage("Failed to add queries to dashboard");
//       setIsErrorDialogOpen(true);
//     } finally {
//       setLoading(false);
//     }
...
//   // Force open error dialog (for testing)
//   const testErrorDialog = () => {
//     setErrorDialogMessage("Test error dialog");
//     setIsErrorDialogOpen(true);
//   };
...
//   console.log("Error dialog state:", isErrorDialogOpen, errorDialogMessage);
...
//       {/* Error Dialog - Explicitly rendered with z-index and forced visibility */}
...
//           <DialogFooter>
//             <Button
//               className="bg-[#381952] text-white"
